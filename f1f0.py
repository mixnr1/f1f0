    ...
    if list[3]>0: 
        ...
        for i in range(len(nested_list)):
            if (list[3]<0)==True and ((nested_list[i][3]+list[3])>0)==True: 
                ...
                print("FINAL SELL_date",pardosanas_datums,\
                "|SELL_rate", pardosanas_kurss, \
                "|SOLD_BTC", abs(pardotie_btc),\
                "|SELL_value", round(pardosanas_vertiba, 2), \
                "|BUY_date",iegades_datums,\
                "|BUY_rate",iegades_kurss,\
                "|BUY_value",round(iegades_vertiba,2),\
                "|Profit",pelna)#, \
                # "| TAX",nodoklis)
                break
                ...
                print("OUTGI SELL_date", pardosanas_datums,\
                "|SELL_rate", pardosanas_kurss,\
                "|SOLD_BTC", pardotie_btc,\
                "|SELL_value", round(pardosanas_vertiba, 2), \
                "|BUY_date", iegades_datums, \
                "|BUY_rate", iegades_kurss, \
                "|BUY_value",round(iegades_vertiba,2),\
